            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <center>    <span class="pull-right"><?= t('app', 'Complete calendar of ICOs')?></span>
</center>   </div>
                        
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                     <center>       <a href="<?= url(['/listing/post']); ?>" class="btn-as secondary"><i class="fa fa-plus" aria-hidden="true"></i><?=t('app','Advertise ICO');?></a>
</center>        </div>
