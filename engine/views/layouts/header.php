                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div id="nav-mobile" class="collapse mobile-menu-wrapper">
                            <ul>
                                ...
                                <li><a href="<?=url(['account/info']);?>"><i class="fa fa-cog" aria-hidden="true"></i><?=t('app','Account Details');?></a></li>
                                ...
                                <li><a href="<?=url(['account/favorites']);?>"><i class="fa fa-folder-o" aria-hidden="true"></i><?=t('app','Favorites');?></a></li>
                                ...
                                <?php } ?>
                                <li><a href="<?=url(['account/logout']);?>"><i class="fa fa-power-off" aria-hidden="true"></i><?=t('app','Sign out');?></a></li>
                                <?php } else { ?>
                                <li><a href="<?=url(['account/join']);?>"><i class="fa fa-cube" aria-hidden="true"></i><?=t('app','Sign up');?></a></li>
                                <li><a href="<?=url(['account/login']);?>"><i class="fa fa-hdd-o" aria-hidden="true"></i><?=t('app','Sign in');?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="main-navigation">
                            ...
                            <div class="btn-group hidden-xs">
                                <a href="javascript:;" class="btn-as transparent dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i class="fa fa-bar-chart" aria-hidden="true"></i><?=t('app','Control Panel');?> 
                                </a>
                                <div class="dropdown-menu">
                                    <?php if (app()->customer->isGuest == false) { ?>
                                        <a href="<?=url(['account/info']);?>"><i class="fa fa-cog" aria-hidden="true"></i><?=t('app','Account Details');?></a>
                                        <?php if (app()->customer->identity->group_id == 2) { ?>
                                        ...
                                        <a href="<?=url(['account/favorites']);?>"><i class="fa fa-folder-o" aria-hidden="true"></i><?=t('app','Favorites');?></a>
                                        <?php if (options()->get('app.settings.invoice.disableInvoices', 0) == 0){ ?>
                                            <a href="<?=url(['account/invoices']);?>"><i class="fa fa-file-o" aria-hidden="true"></i><?=t('app','Invoices');?></a>
                                        <?php } ?>
                                        <a href="<?=url(['account/logout']);?>"><i class="fa fa-power-off" aria-hidden="true"></i><?=t('app','Sign out');?></a>
                                    <?php } else { ?>
                                        <a href="<?=url(['account/join']);?>"><i class="fa fa-cube" aria-hidden="true"></i><?=t('app','Sign up');?></a>
                                        <a href="<?=url(['account/login']);?>"><i class="fa fa-hdd-o" aria-hidden="true"></i><?=t('app','Sign in');?></a>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="btn-group hidden-xs">
                                <a href="<?=url(['/listing/post']);?>" class="btn-as reverse"><i class="fa fa-plus" aria-hidden="true"></i><?=t('app','Advertise ICO');?></a>
                            </div>
                        </div>
                    </div>
                </div>
