                    ...
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-lg-push-2 col-md-8 col-md-push-2 col-sm-12 col-xs-12">
                                <h1><?= ($action == 'update') ? t('app', 'Update your ICO') : t('app', 'Advertise your ICO'); ?></h1>
                            </div>
                        </div>
                    </div>
                    <br>
                 <center>  
                    <br> The listing fee for 15 days is 0.03BTC.
                    <br>
                    <br>
                            ...
                            <div class="col-lg-8 col-lg-push-2 col-md-8 col-md-push-2 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        ])->textInput([ 'placeholder' => t('app','Enter the ICO name - If presale, type (PRESALE) plus ICO name'), 'class' => 'form-control'])->label(false); ?>
                                    </div>
                                </div>
                                <br>
                             <u>  <center> <br>Please provide following information below in the ICO description:</u>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="separator-text">
                                            <span><?=t('app','Choose industry/ category');?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <center>Web address ICO whitepaper</center>
                                <br>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <center>Country of incorporation</center>
                                <br>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="separator-text">
                                            <span><?=t('app','Upload at least your ICO logo and then - if you like -  up to 19 additional pictures, graphics and screenshots ');?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="block-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="a-center">
                                    <button type="submit" name="process[package]" class="btn-as"><?=t('app','Advertise ICO listing');?></button>
